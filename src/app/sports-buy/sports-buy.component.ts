...
@Component({
  selector: 'app-sports-buy',
  templateUrl: './sports-buy.component.html',
  styleUrls: ['./sports-buy.component.css']
})
export class SportsBuyComponent implements OnInit {
...
this.name = this.data.sports[this.id].name;
this.price = this.data.sports[this.id].price;
this.src=this.data.sports[this.id].images[0].image1;
