...
@Component({
  selector: 'app-fashion-buy',
  templateUrl: './fashion-buy.component.html',
  styleUrls: ['./fashion-buy.component.css']
})
export class FashionBuyComponent implements OnInit {
...
this.name = this.data.fashion[this.id].name;
this.price = this.data.fashion[this.id].price;
this.src=this.data.fashion[this.id].images[0].image1;
